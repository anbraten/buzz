  ...
  <div class="flex gap-2 items-start">
    <div class="relative">
      ...
      <div
        ...
        :class="{
          'bg-amber-100 dark:bg-amber-900': comment.type === 'call' || comment.type === 'internal-note',
          'bg-zinc-100 dark:bg-zinc-900': comment.type === 'agent-reply' || comment.type === 'customer-reply',
        }"
      >
    ...
    <UCard
      class="w-full"
      :class="{ 'bg-amber-100 dark:bg-amber-900': comment.type === 'call' || comment.type === 'internal-note' }"
    >
